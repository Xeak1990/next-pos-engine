...
export default function LoginScreen() {
  ...
  return (
    <main className="bt-grid-glow relative min-h-screen flex flex-col px-4 py-8 text-white sm:px-6 lg:px-10">
      {/* Fondo degradado */}
      ...
      <div className="relative flex-1 flex flex-col justify-center max-w-5xl w-full mx-auto">
        ...
        <section className="bt-panel-charcoal relative overflow-hidden p-6 sm:p-8 w-full max-w-[450px] mx-auto flex flex-col justify-start">
